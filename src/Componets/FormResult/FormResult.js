      ...
      <Table className={classes.table} aria-label="customized table">
        ...
        <TableBody>
            ...
            <StyledTableRow >
              ...
              <StyledTableCell align="left">{resultsData.client}</StyledTableCell>
              <StyledTableCell align="left">{resultsData.contractor}</StyledTableCell>
              <StyledTableCell align="left">{resultsData.description}</StyledTableCell>
              <StyledTableCell align="left">{resultsData.max_X}</StyledTableCell>
              <StyledTableCell align="left">{resultsData.min_X}</StyledTableCell>
              <StyledTableCell align="left">{resultsData.max_Y}</StyledTableCell>
              <StyledTableCell align="left">{resultsData.min_Y}</StyledTableCell>
              <StyledTableCell align="left">{resultsData.max_Z}</StyledTableCell>
              <StyledTableCell align="left">{resultsData.min_Z}</StyledTableCell>
